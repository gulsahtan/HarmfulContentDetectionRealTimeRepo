...
namespace HarmfulContentDetectionRealTime.Models
{
    public class AlcoholCigaretteViolenceModel : Model
    {
        public override int Width { get; set; } = 640;
        public override int Height { get; set; } = 640;
        public override int Depth { get; set; } = 3;

        public override int Dimensions { get; set; } = 16;
...

        {
            ...
            new Label { Id = 11, Name = "cigarette" }
        };

        public override bool UseDetect { get; set; } = true;

        public AlcoholCigaretteViolenceModel()
        {
